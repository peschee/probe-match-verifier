import{C,f as x,o as F,t as f,i as $,s as R,p as c,T as h,a as G,M as y,b as L,n as X,c as M}from"./vendor.0ccd2dbd.js";const W=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function i(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerpolicy&&(o.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?o.credentials="include":s.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=i(s);fetch(s.href,o)}};W();const _=5,b=(e,t)=>(t-e)/t*100,d=(e,t=_)=>parseFloat(`${e}`).toFixed(t),E=e=>e.charAt(0).toUpperCase()+e.slice(1);class P{constructor({debug:t=!1}={}){this.colorConverter=new C,this.isDebug=!1,this.xmlParser=new x.XMLParser({ignoreAttributes:!1}),this.isDebug=t}getRGBWFromBpd(t){if(!x.XMLValidator.validate(t))throw new Error("Could not validate BDP XML.");const{builder_color_space:{head:{L:i,x:r,y:s}}}=this.xmlParser.parse(t);return[[parseFloat(r["@_red"]),parseFloat(r["@_green"]),parseFloat(r["@_blue"]),parseFloat(r["@_white"])],[parseFloat(s["@_red"]),parseFloat(s["@_green"]),parseFloat(s["@_blue"]),parseFloat(s["@_white"])],[parseFloat(i["@_red"]),parseFloat(i["@_green"]),parseFloat(i["@_blue"]),parseFloat(i["@_white"])]]}getRGBWFromBcs(t){if(!x.XMLValidator.validate(t))throw new Error("Could not validate BCS XML.");const{builder_color_space:{data:{patch:i}}}=this.xmlParser.parse(t);return this.getRGBWMatrixFromPatches(i)}getRGBWMatrixFromPatches(t=[]){if(t.length<1)return;const i=t.filter(a=>!(a.stimuli.red===0&&a.stimuli.green===0&&a.stimuli.blue===0)).filter(a=>!(a.stimuli.red===1&&a.stimuli.green===1&&a.stimuli.blue===1)),{results:{XYZ:r=void 0}={}}=i.filter(a=>a.stimuli.green===0&&a.stimuli.blue===0).shift()||{},{results:{XYZ:s=void 0}={}}=i.filter(a=>a.stimuli.red===0&&a.stimuli.blue===0).shift()||{},{results:{XYZ:o=void 0}={}}=i.filter(a=>a.stimuli.red===0&&a.stimuli.green===0).shift()||{},[{results:{XYZ:l=void 0}={}}]=t.filter(a=>a.stimuli.red!==0&&a.stimuli.red!==1&&a.stimuli.green!==0&&a.stimuli.green!==1&&a.stimuli.blue!==0&&a.stimuli.blue!==1);if(this.isDebug&&(console.log("redXYZ",r),console.log("greenXYZ",s),console.log("blueXYZ",o),console.log("whiteXYZ",l)),!r||!s||!o||!l)return;const u=this.colorConverter.XYZ_to_xyY([r.X,r.Y,r.Z]),g=this.colorConverter.XYZ_to_xyY([s.X,s.Y,s.Z]),m=this.colorConverter.XYZ_to_xyY([o.X,o.Y,o.Z]),v=this.colorConverter.XYZ_to_xyY([l.X,l.Y,l.Z]);return[[u[0],g[0],m[0],v[0]],[u[1],g[1],m[1],v[1]],[u[2],g[2],m[2],v[2]]]}getRGBWIndexForColor(t){return{red:0,green:1,blue:2,white:3}[t]}}var k=`:host{--app-spacing-header: var(--sl-spacing-medium);font-family:var(--sl-font-sans);line-height:var(--sl-line-height-dense);padding:0 var(--sl-spacing-small);display:block}h1,h2,h3,p{margin:0 0 var(--sl-spacing-small)}a{color:var(--sl-color-primary-800)}h1{font-size:var(--sl-font-size-x-large);font-weight:var(--sl-font-weight-bold)}h2{font-size:var(--sl-font-size-large);font-weight:var(--sl-font-weight-semibold)}h3{font-size:var(--sl-font-size-medium);font-weight:var(--sl-font-weight-semibold)}ol li{margin-bottom:var(--sl-spacing-medium)}.text-success{color:var(--sl-color-success-700)}.text-error{color:var(--sl-color-danger-600)}.text-red{color:var(--sl-color-red-600)}.text-green{color:var(--sl-color-green-600)}.text-blue{color:var(--sl-color-blue-600)}.text-white{color:var(--sl-color-gray-600)}table{font-family:var(--sl-font-mono);font-size:var(--sl-font-size-small)}td{padding:var(--sl-spacing-x-small) var(--sl-spacing-x-small)}th{padding:var(--sl-spacing-2x-small) var(--sl-spacing-x-small)}tr.separator th{padding-top:var(--sl-spacing-large)}.profile-comparison th{text-align:right}td{text-align:right;font-weight:600}th{font-weight:var(--sl-font-weight-normal);font-family:var(--sl-font-sans)}td.red{background:var(--app-color-bg-r)}td.green{background:var(--app-color-bg-g)}td.blue{background:var(--app-color-bg-b)}td.white{background:var(--app-color-bg-w)}tr.red td{background:var(--app-color-bg-r)}tr.green td{background:var(--app-color-bg-g)}tr.blue td{background:var(--app-color-bg-b)}tr.white td{background:var(--app-color-bg-w)}tr.red td.clear,tr.green td.clear,tr.blue td.clear,tr.white td.clear{background:transparent}.number-percent:after{content:"%"}.align-percent:after{content:"%";opacity:0}.table-responsive{display:block;width:100%;overflow-x:auto}.about-dialog{--width: 70ch}.about-dialog>.logo{max-width:32px;height:auto}.app-title{display:flex;align-items:center}.app-title>.logo{max-width:32px;height:auto;margin-right:var(--sl-spacing-small)}.app-header{position:fixed;top:0;left:0;width:100%;background:white;display:flex;justify-content:space-between;align-items:flex-start;z-index:1;border-bottom:1px solid var(--sl-input-border-color)}.app-header>.title{margin:var(--app-spacing-header) 0 var(--app-spacing-header) var(--app-spacing-header)}.app-header>.info{margin:var(--app-spacing-header) var(--app-spacing-header) var(--app-spacing-header) 0}.app-content{padding-top:80px;display:grid;grid-template-columns:1fr;column-gap:var(--sl-spacing-x-large);row-gap:var(--sl-spacing-x-large)}@media screen and (min-width: 900px){.app-content{grid-template-columns:fit-content(20%) auto}}.table-section{margin-bottom:var(--sl-spacing-x-large)}.table-section:last-child{margin-bottom:0}.table-section>.title{margin-bottom:0}.table-section>.file{margin-bottom:var(--sl-spacing-small)}.app-name{font-size:var(--sl-font-size-medium)}.app-name>.full{display:none}@media screen,print and (min-width: 512px){.app-name{font-size:var(--sl-font-size-large)}.app-name>.full{display:block}.app-name>.short{display:none}}@media print{.about-trigger,.load-file-button{display:none}.app-header{border:none}}
`,w="/probe-match-verifier/assets/color-spectrum.97f3c94a.png";const D="probe-match-verifier",I="0.0.0",Z="ColourSpace Probe Match Verifier",N={start:"vite",clean:"rimraf dist coverage",build:"pnpm run clean && tsc && vite build","build:gh-pages":"pnpm run build -- --base=/probe-match-verifier/",preview:"pnpm run build && vite preview",lint:"run-p lint:*","lint:eslint":"eslint --ext .js,.ts .","lint:prettier":"prettier '**/*.{js,ts,md,css}' --check","lint:types":"tsc --noEmit",format:"run-s format:*","format:eslint":"eslint --ext .js,.ts . --fix","format:prettier":"prettier '**/*.{js,ts,md,css}' --write",test:"vitest",coverage:"vitest --coverage",postinstall:"rimraf 'public/shoelace' && cpy 'node_modules/@shoelace-style/shoelace/dist/assets/icons' 'public/shoelace/assets/icons'"},S=["colourspace","lightillusion","probe","matching","verification","spectro"],U="Peter Siska <63866+peschee@users.noreply.github.com>",z="MIT",A={"@types/node":"^17.0.5","@typescript-eslint/eslint-plugin":"^5.8.1","@typescript-eslint/parser":"^5.8.1",c8:"^7.10.0","cpy-cli":"^3.1.1",eslint:"^8.5.0","eslint-config-prettier":"^8.3.0","npm-run-all":"^4.1.5",prettier:"^2.5.1",rimraf:"^3.0.2","ts-lit-plugin":"^1.2.1",typescript:"^4.5.4",vite:"^2.7.10","vite-plugin-html":"^2.1.2","vite-remark-html":"^1.1.1",vitest:"^0.0.124"},T={"@shoelace-style/shoelace":"^2.0.0-beta.63","browser-fs-access":"^0.23.0","cie-colorconverter":"^2.0.1","fast-xml-parser":"^4.0.0-beta.8",lit:"^2.0.2","normalize.css":"^8.0.1"};var B={name:D,version:I,description:Z,scripts:N,keywords:S,author:U,license:z,devDependencies:A,dependencies:T},V=`<h1>ColourSpace Probe Match Verifier</h1>
...
`,O=Object.defineProperty,j=Object.getOwnPropertyDescriptor,p=(e,t,i,r)=>{for(var s=r>1?void 0:r?j(t,i):t,o=e.length-1,l;o>=0;o--)(l=e[o])&&(s=(r?l(t,i,s):l(s))||s);return r&&s&&O(t,i,s),s};M("/probe-match-verifier/shoelace");const Y=!1;let n=class extends R{constructor(){super();this.csXML=new P({debug:Y})}async connectedCallback(){super.connectedCallback()}render(){return c`
